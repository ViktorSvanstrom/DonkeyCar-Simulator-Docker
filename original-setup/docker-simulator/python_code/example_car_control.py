...
Detta är en hybrid implementation där simulatorn körs i Docker
men Python-koden körs lokalt på din dator
"""
...
def main():
    print("Ansluter till DonkeyCar simulator (Docker container)...")
    ...
    # VIKTIGT: host är "localhost" eftersom simulatorn körs i Docker men Python lokalt
    conf = {
        "host": "localhost",  # Anslut till Docker container via localhost
        "port": 9091,
        "start_delay": 5.0,
        "max_cte": 8.0,
        "frame_skip": 1,
    ...
    try:
        ...
        try:
            ...
            try:
                ...
                print("\nFelsökning:")
                print("1. Kontrollera att Docker-containern körs: docker-compose up")
                print("2. Kontrollera att port 9091 är exponerad")
                print("3. Vänta några sekunder efter att containern startat")
                return
